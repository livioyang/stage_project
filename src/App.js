...
export default function App() {
  ...
  const itemsPerPage = 2; //num di items per pagina max=40
...
//richiesta dato dal backeand
 useEffect(() => {
  ...
  try {
    ...
    //const responseFilm = await axios.post('http://127.0.0.',) da modificare in
     //const responseSerie = await axios.post('',) da modificare in
